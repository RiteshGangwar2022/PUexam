  ...
  return (
    <Confidential>
        ...
        <div className=" bg-white shadow-md rounded-xl  p-3 ">
          <h1 className="font-bold text-3xl p-2">Latest Papers</h1>

        </div>
        <div className="bg-white shadow-md rounded-xl   p-3   ">
          <h1 className="text-3xl font-bold p-2">Papers Seen</h1>
          <div className="flex gap-4">
            ...
            <div className=" bg-gray-100 shadow-md rounded-xl w-60 h-50 border-2 border-gray-500 p-6 font-bold  ">
              Total Papers {data1[0].students + data1[1].students}
              <br></br>
              Papers Not Seen: {data1[0].students}
              <br></br>
              Papers Seen: {data1[1].students}
            </div>
          </div>
        </div>
